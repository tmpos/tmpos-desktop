...
const { taxName, taxFullName } = useLocaleProfile()
        ...
        <div class="rounded-xl border border-surface-200 dark:border-surface-700 bg-surface-0 dark:bg-surface-800 p-5 space-y-4">
          ...
          <div class="grid grid-cols-3 gap-3">
            ...
            >
              ...
              <span class="text-[10px] text-center mt-1.5" :class="Number(form.impuesto_incluido) === 2 ? 'text-white/70' : 'text-surface-400'">{{ form.moneda }}100 sin {{ taxName }}</span>
            </button>
            <button
              class="relative flex flex-col items-center justify-center p-4 rounded-xl border-2 transition-all cursor-pointer font-semibold"
            ...
            >
              ...
              <span class="text-[10px] text-center mt-1.5" :class="Number(form.impuesto_incluido) === 1 ? 'text-white/70' : 'text-surface-400'">{{ form.moneda }}100 ya incluye {{ form.impuesto }}% {{ taxName }}</span>
            </button>
          </div>
