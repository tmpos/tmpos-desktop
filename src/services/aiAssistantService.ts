...
const tools = [
  ...
  },
  {
    ...
    description: 'Busca clientes por nombre, telefono, cedula, RNC o email.',
    strict: true,
    parameters: {
      type: 'object',
      properties: {
  ...
  },
  {
    ...
    parameters: {
      ...
      properties: {
        ...
        cliente: { type: 'string', description: 'Nombre, telefono, cedula o RNC del cliente. Puede ser CONSUMIDOR FINAL.' },
