...
[![Versión](https://img.shields.io/badge/versión-2.13.2-2563eb)](https://github.com/tmpos/tmpos-desktop/releases/tag/v2.13.2)
[![Descargas](https://img.shields.io/github/downloads/tmpos/tmpos-desktop/v2.13.2/total)](https://github.com/tmpos/tmpos-desktop/releases/tag/v2.13.2)
...
[![Descargar TMPOS v2.13.2](https://img.shields.io/badge/Descargar_TMPOS-v2.13.2-16a34a?style=for-the-badge&logo=windows)](https://github.com/tmpos/tmpos-desktop/releases/download/v2.13.2/TMPOS.Setup.2.13.2.exe)
...
1. Descarga `TMPOS.Setup.2.13.2.exe`.
...
Consulta todos los archivos y notas en la página del [release v2.13.2](https://github.com/tmpos/tmpos-desktop/releases/tag/v2.13.2).
