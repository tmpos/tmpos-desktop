...
[![Versión](https://img.shields.io/badge/versión-2.13.1-2563eb)](https://github.com/tmpos/tmpos-desktop/releases/tag/v2.13.1)
[![Descargas](https://img.shields.io/github/downloads/tmpos/tmpos-desktop/v2.13.1/total)](https://github.com/tmpos/tmpos-desktop/releases/tag/v2.13.1)
...
[![Descargar TMPOS v2.12.16](https://img.shields.io/badge/Descargar_TMPOS-v2.12.16-16a34a?style=for-the-badge&logo=windows)](https://github.com/tmpos/tmpos-desktop/releases/download/v2.12.16/TMPOS.Setup.2.12.16.exe)
...
1. Descarga `TMPOS.Setup.2.12.16.exe`.
...
Consulta todos los archivos y notas en la página del [release v2.13.1](https://github.com/tmpos/tmpos-desktop/releases/tag/v2.13.1).
